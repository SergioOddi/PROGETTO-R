####### ANALISI preliminare dei dati FINALIZZATA NAPOLI
####### 14 maggio 2021
#######
...
dati_completi = Dati_espressione_genica_finalizzata_Napoli_xlsx_Muscolare # dataset classico, con ogni variabile per colonna
...
dati_dieta1 <- subset(dati_reshaped, Dieta == "1") 
datiCB1 <- subset(dati_dieta1, variable == "CB1")
