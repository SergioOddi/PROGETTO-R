...
dati <- DATASET_DEMETRA_PLASMA_CONIUGATI_SOLO_GLI_ANALIZZATI # dataset classico, con ogni variabile per colonna

####### Eliminare/selezionare gruppi
### Se serve rimuovere osservazioni falsate
#dati <- subset(dati, Group != "AD SEVERE")
#dati <- subset(dati, Group == "AD MILD" | Group == "AD MODERATE")
...
dati <- dati_time1[, c(3, 5:7, 9)] #Prendo solo la colonna gruppi e le colonne con le variabili
