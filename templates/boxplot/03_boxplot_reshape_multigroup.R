###### BOXPLOT MULTIPLI con reshaping tre o più gruppi
### Versione 1.0: Confronto tra due gruppi (ANOVA a una via)
### 19 marzo 2023
...
#dati <- dati_reshaped[which(dati_reshaped$variable == "2AG"), ] 
...
p <- ggboxplot(
  ...
  add="dotplot",
  add.params = list(dotsize = 0.5,      #### Dimensione dei punti
                    alpha = 1, 
