...
#Escludo e righe colonne inutili
dati <- dati[-c(5, 9,10,15,16,25,26), -c(1, 3, 4, 5)]
...
#dati <- dati[which(dati$variable == "STAT1" |
                     dati$variable == "MRC1" |
                     dati$variable == "IRF4" |
                     dati$variable == "IDO1" |
                     dati$variable == "COX2" |
...
dati <- dati[which(dati$variable == "COX2" ), ]
