#### PCA su campioni marina 8 gruppi
## 20 gennaio 2021
...
dati <- subset(dati, Subjects != "Healthy") #Healthy è il primo gruppo da rimuovere dal dataset


#seleziono il vettore Group e 5 fattori (variabili)
# MRC1   TGM2   CXCL8       IRF4      IDO1  `COX-2`
...
dati <- subset(dati, Subjects != "Moderate") #Healthy è il primo gruppo da rimuovere dal dataset
