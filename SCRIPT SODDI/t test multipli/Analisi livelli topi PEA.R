#ANALISI LIVELLI topi Finalizzata

###### Data: 12 maggio 2021
###### Campioni di sangue analizzati da F. Fanti
...
#Rimuovo i soggetti della prima tornata
dati_completi <- subset(dati_completi, Tornata != "Prima") #Prima è il primo gruppo da rimuovere dal dataset

## rename columns
dati_completi <- dati_completi %>% rename(AEA = 'AEA (nM)', OEA = 'OEA (nM)', )

### Seleziono colonna Group e le quattro variabili
dati_completi <- dati_completi[, 5:9]
